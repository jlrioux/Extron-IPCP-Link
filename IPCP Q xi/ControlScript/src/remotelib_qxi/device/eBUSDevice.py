...
from extronlib.device import eBUSDevice as ObjectClass
...
class ObjectWrapper(ObjectClass):
    ...
    def __init__(self,p,alias,data):
        ...
        """
        event_attrs = ['Online','Offline','InactivityChanged','LidChanged','ReceiveResponse','SleepChanged']
        self.set_get_attrs = ['DeviceAlias','Host','ID','InactivityTime','LidState','ModelName','PartNumber','SleepState','SleepTimer','SleepTimerEnabled']
