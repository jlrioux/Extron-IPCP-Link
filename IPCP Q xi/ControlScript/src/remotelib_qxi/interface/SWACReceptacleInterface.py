...
from extronlib.interface import SWACReceptacleInterface as ObjectClass
...
class ObjectWrapper(ObjectClass):
    ...
    def __init__(self,p,alias,data):
        ...
        """
        event_attrs = ['CurrentChanged','Online','Offline','StateChanged']
        self.set_get_attrs = ['Current','Host','Port','State']
        self.callable_attrs = {'SetState':None,
                                 'Toggle':None}
