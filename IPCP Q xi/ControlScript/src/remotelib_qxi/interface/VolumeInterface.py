...
from extronlib.interface import VolumeInterface as ObjectClass
...
class ObjectWrapper(ObjectClass):
    ...
    def __init__(self,p,alias,data):
        ...
        self.set_get_attrs = ['Host','Level','Max','Min','Mute','Port','SoftStart']
        self.callable_attrs = {'SetLevel':None,
                                 'SetMute':None,
                                 'SetRange':None,
                                 'SetSoftStart':None}
